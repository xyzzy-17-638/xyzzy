...
** -wow64-redirection
いつもファイル名をネイティブのパスとして扱う。
** -no-wow64-redirection
いつもファイル名をWoW64のリダイレクションのパスとして扱う
...
** *frame-init-width* *frame-init-height*
この二つの変数が無い場合はこれまで通りrootのフレームと同じ初期サイズ、これらの変数にfixnumが指定されていた時はその幅と高さで。
